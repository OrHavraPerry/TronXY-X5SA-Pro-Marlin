...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB  //MOTHERBOARD BOARD_RAMPS_14_EFB BOARD_MAKEBOARD_MINI  
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Make-It"
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -40  // X offset: -left  +right  [of the nozzle]-40 10 SET FOR tronxy x5sa pro 
#define Y_PROBE_OFFSET_FROM_EXTRUDER  -10 // Y offset: -front +behind [the nozzle]-10  10
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      25.0  // (°C) Default bed temperature for the G26 Mesh Validation Tool.
  #endif
